...
if(isset($_SESSION['id']) && isset($_POST['aggiungi']))
...

    {
        if(isset($_SESSION['carrello']))
        {
            ...
            $_SESSION['carrello'][$count] = array('Nome' =>$_POST['nome'], 'Prezzo' =>$_POST['prezzo'], 'Quantita'=>$_POST['qty']);
            header("location: carrello.php");
        ...
        {
            $_SESSION['carrello'][0]= array('Nome' =>$_POST['nome'], 'Prezzo' =>$_POST['prezzo'], 'Quantita'=>$_POST['qty']);
            header("location: carrello.php");
        }
